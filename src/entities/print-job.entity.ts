...
export interface FilamentTracking {
  spoolmanId?: number;        // Spoolman spool ID
  openPrintTagId?: string;    // OpenPrintTag NFC ID

  estimatedUsageGrams: number | null;
  actualUsageGrams?: number | null;

  // Multi-tool filament
  spools?: Array<{
    toolIndex: number;
    spoolmanId?: number;
    openPrintTagId?: string;
    usageGrams?: number;
  }>;
}
...
export class PrintJob {
  ...
  // Filament tracking
  @Column({ type: "json", nullable: true })
  filamentTracking: FilamentTracking | null;

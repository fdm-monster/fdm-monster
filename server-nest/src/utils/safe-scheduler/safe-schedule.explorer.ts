...
@Injectable()
export class SafeScheduleExplorer implements OnModuleInit {
  ...
  private wrapFunctionInTryCatchBlocks(methodRef: Function, instance: object) {
    return async (...args: unknown[]) => {
      try {
        ...
        this.logger.error(`Error in decorated Cron/Interval/Timeout task - ${errorSummary(e)}`, SafeScheduleExplorer.name);

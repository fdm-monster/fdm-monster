...
class OctoPrintRoutes {
    ...
    _prepareRequest(printer, path, timeoutOverride = this._timeouts.apiTimeout, contentType = jsonContentType) {
    ...
    _prepareJsonRequest(printer, path, data, timeoutOverride = this._timeouts.apiTimeout) {

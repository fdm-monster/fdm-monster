...
import {multiPartContentType} from "./constants/octoprint-service.constants";
import {checkPluginManagerAPIDeprecation} from "../../utils/compatibility.utils";
...
class OctoPrintApiService extends OctoPrintRoutes {
    ...
    async getAdminUserOrDefault(printer) {
        const data: { users?: any[] } = await this.getUsers(printer);

...
const OP_STATE = {
    ...
    StartingPrintFromSD: "Starting print from SD",
    StartSendingPrintToSD: "Starting to send file to SD",
    Starting: "Starting",
    TransferringFileToSD: "Transferring file to SD",
    PrintingFromSD: "Printing from SD",
    SendingFileToSD: "Sending file to SD",
    Printing: "Printing",
...
function remapOctoPrintState(octoPrintState) {
    ...
    const mapping: any = OF_STATE_REMAP[stateLabel];
    mapping.flags = flags;
    if (!!mapping)
        return mapping;
    return {
...
export {mapStateToColor};
export {remapOctoPrintState};
export {ERR_COUNT};
export {MESSAGE};
export {PSTATE};
export {OP_STATE};

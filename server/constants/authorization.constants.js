...
function allPerms(group) {
    if (!group)
        throw new Error(`Permission group name '${group}' was not found`);
...
const ROLE_PERMS = {
    [ROLES.ADMIN]: union(allPerms(PERM_GROUP.Alerts), allPerms(PERM_GROUP.PrinterFiles), allPerms(PERM_GROUP.PrinterGroups), allPerms(PERM_GROUP.PrinterSettings)),
...
export { ROLES };
export { PERMS };
export { flattenPermissionDefinition };
export { ROLE_PERMS };
export default {
    ROLES,
    PERMS,

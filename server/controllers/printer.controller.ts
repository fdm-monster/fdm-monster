...
import {convertHttpUrlToWebsocket} from "../utils/url.utils";
import DITokens from "../container.tokens";
import {getSettingsAppearanceDefault, Status} from "../constants/service.constants";
...
class PrinterController {
    ...
    async reconnectOctoPrint(req, res) {
        const {currentPrinterId} = getScopedPrinter(req);
        this.#logger.info("Reconnecting OctoPrint API connection", currentPrinterId);

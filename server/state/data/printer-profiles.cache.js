class PrinterProfilesCache {
    ...
    setPrinterProfiles(printerId, profiles) {
        const printerProfiles = this.#printerProfiles.find((profile) => profile.printerId.toString() === printerId);
        if (!printerProfiles) {
...
export default PrinterProfilesCache;
